    ...
    <article>
      ...
      <Demo title="基础用法">
        ...
        <div slot="desc">
          ...
          <p>可以给<code>sg-select</code>添加 style 样式，比如宽度。</p>
      ...
      <Demo title="尺寸">
        <div slot="demo">
          <sg-select v-model="model2" size="small" style="width:100px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
          <sg-select v-model="model3" style="width:100px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
          <sg-select v-model="model4" size="large" style="width:100px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
        </div>
        <div slot="desc">
      ...
      <Demo title="禁用">
        <div slot="demo">
          <sg-select v-model="model5" disabled style="width:200px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
          <sg-select v-model="model6" style="width:200px">
        ...
        <div slot="desc">
          <p>通过给<code>sg-select</code>设置属性<code>disabled</code>禁用整个选择器。</p>
      ...
      <Demo title="可清空">
        <div slot="demo">
          <sg-select v-model="model8" clearable style="width:200px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
      ...
      <Demo title="分组">
        <div slot="demo">
          <sg-select v-model="model7" style="width:200px">
      ...
      <Demo title="自定义模板">
        <div slot="demo">
          <sg-select v-model="model9" style="width:200px">
      ...
      <Demo title="多选">
        <div slot="demo">
          ...
          <sg-select v-model="model10" multiple style="width:260px">
            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </sg-select>
        </div>
        <div slot="desc">
      ...
      <Demo title="可搜索">
        <div slot="demo">
              <sg-select v-model="model11" filterable>
                <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
              </sg-select>
              <sg-select v-model="model12" filterable multiple>
                <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
              </sg-select>
        </div>
        <div slot="desc">
      ...
      <div class="api">
        ...
        <Anchor title="sg-select props" h3></Anchor>
        <table>
          <thead>
          <tr>
            <th>属性</th>
        ...
        <Anchor title="sg-select events" h3></Anchor>
        <table>
          <thead>
          <tr>
            <th>事件名</th>
        ...
        <Anchor title="sg-select methods" h3></Anchor>
        <table>
          <thead>
          <tr>
            <th>方法名</th>
