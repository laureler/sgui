  ...
  <i-article>
    <article>
      ...
      <Demo title="配合外部组件使用">
        ...
        <i-code lang="html" slot="code">{{ code.out }}</i-code>
      </Demo>
      <Demo title="自定义更多样式">
        <div slot="demo">
        ...
        <div slot="desc">
          <p>通过自定义slot和属性stroke-width改变进度条效果。</p>
        </div>
        <i-code lang="html" slot="code">{{ code.self }}</i-code>
      </Demo>
      ...
      <table>
        ...
        <tr>
          <td>status</td>
          <td>状态，可选值为normal、active、wrong、success</td>
          <td>String</td>
          <td>normal</td>
        </tr>
        <tr>
...
<script>
  ...
  import Code from '../code/processbar';
