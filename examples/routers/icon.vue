...
<template>
  <i-article>
    <article>
      ...
      <p>sgui 的图标使用开源项目<a href="http://ionicons.com/" target="_blank"><Icon type="ionic"></Icon> ionicons</a></p>
      ...
      <div class="icons">
        <div class="icons-item" v-for="item in filterIcons" @click="clip(item)">
          <i class="sg-icon" :class="[`sg-icon-${item.name}`]" style="font-size:32px"></i>
          <p>
            {{ item.name }}
          </p>
        </div>
